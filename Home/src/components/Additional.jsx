...
const Additional = () => {
  return (
    <div>
    <div className="m-6 h-20 border border-gray-300 border-r-0 border-l-0 lg:mb-0 lg:mt-2">
      <h2 className="text-[#003339] mt-5 text-2xl font-semibold lg:mt-1 lg:text-sm">
        Additional Info
      </h2>
